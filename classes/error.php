...
class Errors
{
    public static function killapp($reason,$title){
        ?>
        <div class="wrapper">
            <h2><?php echo $title; ?></h2>
            <p><?php echo $reason; ?></p>
            <div class="buttons"><span>Skyfallen App Engine</span></div>
        </div>
        <div class="space">
        ...
        <style>
            *, :before, :after {
            ...
            .ship {
                ...
                width: 55px;
                margin-left: 10px;
                background: url("/img/spaceship.png") center/contain no-repeat;
